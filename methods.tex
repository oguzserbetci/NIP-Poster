...
\end{subfigure}
\caption{The two experiment scenarios and their respective UI}
\end{figure}
...
\begin{itemize}
    ...
    \begin{figure}
        ...
        \caption{The updated believe $b'$ given a current believe $b$ and an observation $o$, computed using bayesian estimation}
    \end{figure}
