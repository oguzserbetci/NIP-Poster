...
\author{Jan Botsch, Emil Azadian, Oǧuz Şerbetci, Vlad, Stephan Tietz} % Author(s)
...
\begin{itemize}
    \item Humans do not act rationally.
    \item Exponential Utility cannot model all risk-behavior observed in humans.
...
\begin{itemize}
    \item Derive arbitrary utility functions from human behaviour/supervision.
    \item Asses how well humans can learn to approximate the state of the environment, and if it plays a role in their risk behavior.
    \item Demonstrate advantages in high-risk use-cases such as flight control.
\end{itemize}
