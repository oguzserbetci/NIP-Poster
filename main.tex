...
{\begin{tikzpicture}[remember picture, overlay]
     ...
     {\includegraphics[height=3cm]{img/TU.png}};
  \end{tikzpicture}}

\addtobeamertemplate{headline}{} 
{\begin{tikzpicture}[remember picture, overlay]
     \node [anchor=north west, inner sep=3cm]  at (current page.north west)
     {\includegraphics[height=3cm]{img/NI.png}};
  \end{tikzpicture}}
...
%\setbeamercolor{exampleblock}{parent=structure,bg=white}
%\setbeamercolor{block begin}{parent=structure,bg=white}
%\setbeamercolor{block alerted begin}{parent=structure,bg=white}
...
\begin{itemize}
    \item Participants could be categorized into three different groups of risk-behavior.
    \item Exponential utility cannot model all human risk-behavior.
    \item Sinh and dynamic utility functions might be reasonable alternative choices.
    \item Agent with higher risk affinity $\rightarrow$ Higher variance in rewards.
\end{itemize}
...
\begin{itemize}
    \item End-to-end method for deriving utility functions from human behavior (i.e. solve the inverse problem).
