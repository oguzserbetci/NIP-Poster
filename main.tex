...
\author{Jan Botsch, Emil Azadian, Oǧuz Şerbetci, Vlad Frasineanu, Stephan Tietz} % Author(s)
...
% TODO touch on objectives.

\begin{itemize}
    %TOOD reforumlate this @oguz :)
    \item People could be categorized into three main groups.
...
\begin{itemize}
    \item End-to-end method for deriving utility functions from human behaviour.
    \item Apply in high-risk use-cases such as flight control.
\end{itemize}
